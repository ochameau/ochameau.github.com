...
function TracingListener(contentTypeObserver, requestListener, requestInfo) {
...
function addContentTypeObserver(contentTypeObserver) {
  ...
  var internalHttpResponseObserver = {
    observe : function(channel) {
      ...
      var newListener = new TracingListener(contentTypeObserver,requestListener,requestInfo);
